...
const MyApplications = () => {
  ...
  useEffect(() => {
    try {
      if (user && user.role === "Employer") {
        setLoading(true);
        axios
        .get("https://job-portal-nodejs-api.vercel.app/api/v1/application/employer/getall", {
        ...
        setLoading(true);
        axios
          .get("https://job-portal-nodejs-api.vercel.app/api/v1/application/jobseeker/getall", {
            withCredentials: true,
          })
          .then((res) => {
            setApplications(res.data.applications);
  ...
  const confirmDelete = async () => {
    ...
    try {
      axios
        .delete(`https://job-portal-nodejs-api.vercel.app/api/v1/application/delete/${deleteApplicationId}`, {
          withCredentials: true,
        })
        .then((res) => {
